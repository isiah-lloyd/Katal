...
(function() {
    ...
    var rmp = function(options) {
      ...
      priv.selectors = {
        ...
        fname: "#mainContent > div.right-panel > div.chegg-bg > div.top-info-block > div.result-info > div.result-name > h1 > span:nth-child(1)",
        lname: "#mainContent > div.right-panel > div.chegg-bg > div.top-info-block > div.result-info > div.result-name > h1 > span.plname",
      ...
      priv.getSearchUrl = function(options) {
        ...
        return "https://www.ratemyprofessors.com/search.jsp?query=" +
      ...
      priv.urlFromListing = function(elem) {
        elem = $(elem);
        return "https://www.ratemyprofessors.com" + $("a", elem).attr('href');
      };
